...
public class GameControllerImg : MonoBehaviour
{
    public List<ImgQuiz> Questions;
    ...
    void SetAnswers()
    {
        ...
        {
            options[i].GetComponent<CheckerImg>().isRight = false;
            ...
            {
                correctop = i;
                options[i].GetComponent<CheckerImg>().isRight = true;
            }
        }
    }
    ...
    void getQuestion()
    {
        if(Questions.Count > 0)
        {
            ...
            DisplayQuestion.sprite = Questions[current].Question;
            SetAnswers();
        }
        else
        {
